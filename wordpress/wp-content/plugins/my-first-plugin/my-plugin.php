...
class WordCountAndTimePlugin {
    ...
    function createHTML($content) {
        ...
        if(get_option('wcp_readtime', '1')) {
            $html .= 'This post will take about ' . round($wordCount/225) . ' minute(s). <br>';
        }
...
function readtimeHTML() { ?>
    <input type="checkbox" name="wcp_readtime" value="1" <?php checked(get_option('wcp_wordcount', '1'))?>>
<?php }

function charactercountHTML() { ?>
    <input type="checkbox" name="wcp_charactercount" value="1" <?php checked(get_option('wcp_wordcount', '1'))?>>
<?php }
